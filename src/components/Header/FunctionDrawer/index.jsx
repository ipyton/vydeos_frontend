...
// const element = React.createElement(eval('(' + jsxString + ')'));
  ...
  let functions = ['Chat', 'Trending', 'Posts', 'Videos', 'Edit', 'Friend', 'Settings', "Download", "Ask", "Handle Download Request"]
  let routeTable = ['/chat', '/trending', '/', '/videolist', '/edit', '/friends', '/settings', "/download", "/qa", "/downloadRequestsManager"]
